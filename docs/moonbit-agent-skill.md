...
This is the compact MoonBit generation skill that MoonAP can inject into cloud prompts.
...
This summary is intentionally short so it can fit inside LLM prompt budgets.
